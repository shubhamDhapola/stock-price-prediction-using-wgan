...
#     Read the data
   ...
   # # Separate X variables and y variable (closing price)
    ...
    # # Test performance
    # generator_model = tf.keras.models.load_model(f'gen_model_{n_steps_in}_{n_steps_out}_{epoch - 1}.keras')  # fix according to the desired generator to use
    # test_predicted, test_RMSE, test_MAE, test_MAPE = get_test_plot(generator_model, X_test, y_test, y_scaler,
    #                                                                index_test, output_dim)
