...
#     Read the data
    ...
    #Test performance
    generator_model = tf.keras.models.load_model(f'gen_model_{n_steps_in}_{n_steps_out}_{epoch-1}_indi.keras') # fix according to the desired generator to use
